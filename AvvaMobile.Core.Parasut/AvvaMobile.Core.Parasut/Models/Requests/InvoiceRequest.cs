...
public class InvoiceRequest_Data_Attributes
{
    ...
    /// <summary>
    /// Tevkifat oranı. DİKKAT - Paraşüt API'ında fatura seviyesinde böyle bir alan yoktur;
    /// tevkifat oranı kalem bazında verilir:
    /// InvoiceRequest_Data_Relationships_Details_Data_Attributes.vat_withholding_rate.
